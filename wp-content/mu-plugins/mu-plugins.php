...
class just_do_it {
  ...
  function __construct() {
    ...
    $this->must_plugins['JAWSDAYS 2016 Setting']  = 'jawsdays2016-setting/jawsdays-2016-setting.php';
    $this->must_plugins['Contact Form 7']         = 'contact-form-7/wp-contact-form-7.php';
    $this->must_plugins['Flamingo']               = 'flamingo/flamingo.php';
    $this->must_plugins['Simple Post Type Permalinks'] = 'simple-post-type-permalinks/simple-post-type-permalinks.php';
